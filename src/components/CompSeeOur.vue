  ...
  <div>
    ...
    >
      <div class="content bg-light-blue-1">
        <div class="seeour">
          <div class="text">
            <div class="text-h3 text-weight-bolder">See Our Themes Lists</div>
            <div class="text-body1 q-mt-md">
              Create a food delivery or grocery website backed by powerful tools
              that help you find customers, drive sales, and manage your
              day-to-day.Explore More Themes Foodfair
            </div>
          </div>
        </div>
        <div
        ...
        >
          <div
            class="cart bg-white row justify-center"
            v-for="cart in carts"
            :key="cart"
          >
