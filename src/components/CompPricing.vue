<template >
  <div>
    <div class="container bg-grey  row justify-center items-center content-center">
      <div class="content bg-grey-1">
          <div class="pricing bg-red q-mt-xl row justify-center">

             <div class="plans bg-green row justify-center content-center">
                <div class="text-center text-h3 text-weight-bolder">
                    Pricing & Plans
                </div>
          ...
          <div class="uppercart bg-yellow">
              <div class="cart bg-white row justify-center content-center">
                  <div class="innercart bg-grey-1">
                      ...
                      <div class="q-mt-lg">
                          ...
                          <div>
                            <ul class="ul" style="margin-right: 20px;">
